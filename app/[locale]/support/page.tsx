...
const heroTexts = {
  en: {
    ...
    subtitle:
      "Get instant answers to setup guides, network troubleshooting, and plan management. Our global team is here 24/7.",
    searchPlaceholder: "E.g. How to install on iPhone...",
    searchButton: "Search",
    browseByCategory: "Browse by Category",
    commonQuestions: "Common Questions",
    stillNeedHelp: "Still need help?",
    contactSubtitle: "Our support rockstars are online and ready to assist you in 12 languages.",
    systemStatusTitle: "System Status",
    systemStatusSubtitle: "All Systems Operational",
    statusEsimActivation: "eSIM Activation",
    statusPaymentProcessing: "Payment Processing",
    statusViewDetails: "View Detailed Status Page",
    popularArticlesHeading: "Popular Articles",
  },
  tr: {
    badge: "Destek Merkezi",
    title: "Size Nasıl Yardımcı Olabiliriz?",
    subtitle:
      "Kurulum, bağlantı ve paket yönetimi için hızlı cevaplar alın. Küresel destek ekibimiz 7/24 yanınızda.",
    searchPlaceholder: "Örn. iPhone'da nasıl kurarım...",
    searchButton: "Ara",
    browseByCategory: "Kategorilere Göre İncele",
    commonQuestions: "Sık Sorulan Sorular",
    stillNeedHelp: "Hâlâ yardıma mı ihtiyacınız var?",
    contactSubtitle: "Destek ekibimiz 12 dilde size yardımcı olmak için çevrimiçi.",
    systemStatusTitle: "Sistem Durumu",
    systemStatusSubtitle: "Tüm Sistemler Çalışır Durumda",
    statusEsimActivation: "eSIM Aktivasyonu",
    statusPaymentProcessing: "Ödeme İşlemleri",
    statusViewDetails: "Detaylı Durum Sayfasını Görüntüle",
    popularArticlesHeading: "Popüler Makaleler",
  },
} as const;

const trCategoryTitles: Record<string, string> = {
  "Installation & Setup": "Kurulum ve Başlangıç",
  Connectivity: "Bağlantı",
  "Billing & Plans": "Ödemeler ve Paketler",
  Coverage: "Kapsama Alanı",
  "My Account": "Hesabım",
  Troubleshooting: "Sorun Giderme",
};

const trCategoryDescriptions: Record<string, string> = {
  "Installation & Setup": "eSIM aktivasyonu için adım adım rehberler",
  Connectivity: "Şebeke ve hız sorunlarını çözme",
  "Billing & Plans": "Ödemeler, iadeler ve veri kullanımı",
  Coverage: "Dünya çapında destinasyonlar ve operatörler",
  "My Account": "Siparişleri ve profil ayarlarını yönet",
  Troubleshooting: "Teknik sorunlar ve hata kayıtları",
};

const trFaqQuestions: Record<string, string> = {
  "What is an eSIM and how does it work?": "eSIM nedir ve nasıl çalışır?",
  "Is my device compatible with eSIM?": "Cihazım eSIM ile uyumlu mu?",
  "How quickly will I receive my eSIM?": "eSIM’i ne kadar sürede alırım?",
  "How do I activate roaming for my eSIM?": "eSIM için dolaşımı nasıl aktif ederim?",
  "Can I use my eSIM on multiple devices?": "eSIM’i birden fazla cihazda kullanabilir miyim?",
};

const trFaqAnswers: Record<string, string> = {
  "What is an eSIM and how does it work?":
    "eSIM (embedded SIM), fiziksel bir SIM karta ihtiyaç duymadan mobil hat tanımlamanıza izin veren dijital bir SIM’dir. Cihazınızın içine gömülüdür ve farklı operatör profilleriyle uzaktan programlanabilir.",
  "Is my device compatible with eSIM?":
    "2018 sonrası çıkan çoğu akıllı telefon eSIM destekler; örneğin iPhone XS ve üzeri, Samsung Galaxy S20+ ve Google Pixel 3+. Cihaz ayarlarında “eSIM” veya “Hücresel Plan Ekle” seçeneklerini kontrol edebilirsiniz.",
  "How quickly will I receive my eSIM?":
    "Ödemeniz onaylanır onaylanmaz eSIM QR kodunuz birkaç saniye içinde e-posta adresinize gönderilir. Fiziksel teslimat beklemeniz gerekmez.",
  "How do I activate roaming for my eSIM?":
    "Cihaz ayarlarına giderek POLO SIM profili üzerine tıklayın ve “Veri Dolaşımı” seçeneğinin açık olduğundan emin olun. Küresel veri paketlerimizin çalışması için dolaşımın aktif olması gerekir.",
  "Can I use my eSIM on multiple devices?":
    "Hayır, çoğu eSIM profili yalnızca bir kez kurulabilir ve tek bir cihazla eşleşir. Profili silmek genellikle tekrar kullanılamaz hale getirir. Bu yüzden en çok kullanacağınız cihazda kurmanız önerilir.",
};

const trContactTitles: Record<string, string> = {
  "24/7 Live Chat": "7/24 Canlı Sohbet",
  "Email Support": "E-posta Desteği",
  "Direct Call": "Telefon Desteği",
};

const trContactBadges: Record<string, string> = {
  Fastest: "En Hızlı",
  "< 2h response": "< 2 saat içinde yanıt",
  "VIP Line": "VIP Hat",
};
