                  ...
                  {paginatedProducts.map((product) => {
                    ...
                    return (
                      <div
                        ...
                        className={`bg-[var(--navy-light)] rounded-2xl border px-6 py-4 flex items-center justify-between transition-all shadow-sm cursor-pointer ${isItemInCart
                            ? "border-[var(--gold)]"
                      ...
                      >
                        <div className="flex flex-col gap-1">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-white/90 uppercase tracking-wider truncate max-w-[120px]" title={name}>{name}</span>
                          </div>
